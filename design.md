...
- Assets should be Unique by default, the card type roles now becomes to house effects that need or benefit from Unique. It gives it an unique design space.
