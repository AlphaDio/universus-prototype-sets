...
### Capture Strike
- Type: Attack
- Stats: 5 difficulty, 3 control, Mid, 4 speed, 5 damage
- Block: Mid +2
- Symbols: Order / Void
- Tags: Strike / Tactics
...
- Symbols: Order
- Tags: Strike / Tactics
- Text: Enhance: If you blocked with a Tactics card this turn, this Strike attack gets +3 damage.
- Role: Bridge from defense to offense.
...
### Countermand
- Type: Attack
- Stats: 6 difficulty, 2 control, High, 5 speed, 6 damage
- Block: High +1
- Symbols: Order / Void
- Tags: Strike / Tactics
- Keywords: Reversal
